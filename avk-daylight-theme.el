...
;   `(default ((t (:stipple nil :background "gray96" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal ))))
   ...
   `(org-level-1 ((t (:height 1.9 :foreground "slate blue"))))
   `(org-level-2 ((((class color) (min-colors 16) (background light dark)) (:foreground "dark violet" :height 1.6))))
   ...
   `(org-mode-line-clock ((t (:inherit modeline :foreground "dark blue" :slant oblique :height 1.1 :family "ubuntu condensed"))) t)
