...
;   `(default ((t (:stipple nil :background "gray96" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal ))))
   ...
   `(diff-refine-added ((t (:background "spring green"))))
   ...
   `(font-lock-comment-face ((t (:foreground "gray55" :background "grey96" :slant italic))))
   ...
   `(helm-ff-dotted-directory ((t (:foreground "dark green"))))
   `(highlight ((t (:background "light yellow"))))
   `(highlight-changes ((((min-colors 88) (class color)) (:background "yellow"))))
   `(highlight-changes-delete ((((min-colors 88) (class color)) (:background "MistyRose1"))))
   ...
   `(lazy-highlight ((t (:background "light yellow"))))
   ...
   `(org-priority ((t (:foreground "red"))) t)
   ...
   `(org-level-1 ((t (:height 1.2 :foreground "dark slate blue"))))
   `(org-level-2 ((((class color) (min-colors 16) (background light dark)) (:foreground "dark violet" :height 1.1))))
   `(org-level-3 ((t (:foreground "dark red"))))
   `(org-level-4 ((t (:foreground "slate blue"))))
   ...
   `(region ((t (:background "lemon chiffon" :foreground "black"))))
