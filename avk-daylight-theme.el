...
;   `(default ((t (:stipple nil :background "gray96" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal ))))
   ...
   `(lazy-highlight ((t (:background "plum1"))))
   ...
   `(org-level-2 ((((class color) (min-colors 16) (background light dark)) (:foreground "blue violet" :height 1.2))))
   ...
   `(org-scheduled-today ((t (:foreground "blue4"))))
   `(org-scheduled-previously ((t (:foreground "MediumPurple4" :slant italic))))
